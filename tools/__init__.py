...
from tools.window_tools import list_windows, find_window, connect_to_app, start_app, get_window_info
...
window_tools = [list_windows, find_window, connect_to_app, start_app, get_window_info]
